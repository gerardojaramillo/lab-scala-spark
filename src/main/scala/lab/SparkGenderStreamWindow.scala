...
object SparkGenderStreamWindow {
   ...
   * DataTypes.StringType, true)) .add(StructField("paternal",
   * DataTypes.StringType, true)) .add(StructField("maternal",
   * DataTypes.StringType, true)) .add(StructField("birthday",
   * DataTypes.StringType, true)) .add(StructField("gender",
   * DataTypes.StringType, true)) .add(StructField("country",
